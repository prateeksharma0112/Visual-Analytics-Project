...
<!-- <header style="background: #333; color: white; padding: 1rem; text-align: center;">
    ...
    <nav style="margin-top: 10px;">
        ...
        <a href="/ShippingEfficiencyPage" style="color: white; margin-right: 15px; text-decoration: none;">Shipping Efficiency</a>
        <a href="/TemporalTrendsPage" style="color: white; margin-right: 15px; text-decoration: none;">Temporal Trends</a>
        <a href="/DiscountImpactPage" style="color: white; margin-right: 15px; text-decoration: none;">Discount Impact</a>
        <a href="/ExecutiveSummaryPage" style="color: white; text-decoration: none;">Executive Summary</a>
    </nav>
</header> -->
<header style="background: #333; color: white; padding: 1rem; text-align: center;">
    <h1>{title}</h1>
    <nav style="margin-top: 10px;">
        ...
        <a href="/Visual-Analytics-Project/ShippingEfficiencyPage" style="color: white; margin-right: 15px; text-decoration: none;">Shipping Efficiency</a>
        <a href="/Visual-Analytics-Project/ExecutiveSummaryPage" style="color: white; text-decoration: none;">Executive Summary</a>
    </nav>
</header>
