<script>
    ...
    function drawHeatmap() {
        ...
        const aggregatedData = d3.rollups(
            ...
            d => Math.floor(d.Discount * 100 / 10) * 10, // Group discounts into bins of 10% (e.g., 0-10%, 10-20%)
            d => Math.floor(d.Sales / 1000) * 1000 // Group sales into bins of 1000 (e.g., $0-$1000, $1000-$2000)
        );
...
<!-- Filter Section
<section style="text-align: center; margin: 1rem;">
...
<!-- Heatmap Container -->
<div id="heatmap" style="position: relative; padding: 1rem;"></div>
